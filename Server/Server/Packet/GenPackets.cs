...
class C_PlayerInfoReq : IPacket
{
    ...
    public class Skill
    {
        ...
        public bool Write(Span<byte> s, ref ushort count)
        {
            ...
            count += sizeof(float);
            success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)this.attributes.Count);// 크기를 먼저 밀어준다.
            count += sizeof(ushort);
    ...
    public ArraySegment<byte> Write()
    {
        ...
        count += sizeof(ushort);
        count += nameLen;
        success &= BitConverter.TryWriteBytes(s.Slice(count, s.Length - count), (ushort)this.skills.Count);// 크기를 먼저 밀어준다.
        count += sizeof(ushort);
